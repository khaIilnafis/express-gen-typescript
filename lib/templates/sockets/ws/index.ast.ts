 ...
 */
export default function generateWSHandlerAST(_options: GeneratorOptions) {
                                  ...
                                  [
                                    b.templateLiteral(
                                      [
                                        b.templateElement(
                                          {
                                            raw: "WebSocket error for client ",
                                            cooked:
  ...
  const connectionHandler = (
    (
      (
        (
          (arrowFunction.body as recast.types.namedTypes.BlockStatement)
  ...
  const messageHandler = (
    connectionHandler.expression as recast.types.namedTypes.CallExpression
  ).arguments[1] as recast.types.namedTypes.ArrowFunctionExpression;

  const messageParam = messageHandler
    .params[0] as recast.types.namedTypes.Identifier;
  messageParam.typeAnnotation = b.tsTypeAnnotation(b.tsStringKeyword());
