 ...
 */
export default function generateExampleControllerAST(
  ...
  const getAllControllerFunction = b.exportNamedDeclaration(
    b.functionDeclaration(
      b.identifier("getAllController"),
      options.webSockets ? [createSocketParam()] : [],
      b.blockStatement([
        b.returnStatement(
                    ...
                    b.variableDeclarator(
                      ...
                      b.arrayExpression([
                        b.objectExpression([
                          ...
                          b.objectProperty(
                            b.identifier("name"),
                            b.stringLiteral("Example 1"),
                          ),
                          b.objectProperty(
                            b.identifier("description"),
                            b.stringLiteral("Description 1"),
                          ),
                          b.objectProperty(
                            b.identifier("isActive"),
                        ...
                        b.objectExpression([
                          ...
                          b.objectProperty(
                            b.identifier("name"),
                            b.stringLiteral("Example 2"),
                          ),
                          b.objectProperty(
                            b.identifier("description"),
                            b.stringLiteral("Description 2"),
                          ),
                          b.objectProperty(
                            b.identifier("isActive"),
                            b.booleanLiteral(true),
                  ...
                  b.blockStatement([
                    b.expressionStatement(
                      b.callExpression(
                        ...
                        [
                          b.stringLiteral("Error fetching examples:"),
                          b.identifier("error"),
                        ],
                      ),
                    ),
  ...
  const getAllFunctionDecl =
    getAllControllerFunction.declaration as recast.types.namedTypes.FunctionDeclaration;
  const getAllReturnStmt = getAllFunctionDecl.body
    .body[0] as recast.types.namedTypes.ReturnStatement;
  const getAllFunction =
    getAllReturnStmt.argument as recast.types.namedTypes.FunctionExpression;
  ...
  const getByIdControllerFunction = b.exportNamedDeclaration(
    b.functionDeclaration(
      b.identifier("getByIdController"),
      options.webSockets ? [createSocketParam()] : [],
      b.blockStatement([
        b.returnStatement(
          // Create function expression
                  ...
                  b.blockStatement([
                    b.expressionStatement(
                      b.callExpression(
                        ...
                        [
                          b.stringLiteral("Error fetching example:"),
                          b.identifier("error"),
                        ],
                      ),
                    ),
  ...
  // Get the function expression from the return statement - need to cast to access the proper types
  const getByIdFunctionDecl =
    getByIdControllerFunction.declaration as recast.types.namedTypes.FunctionDeclaration;
  const getByIdReturnStmt = getByIdFunctionDecl.body
    .body[0] as recast.types.namedTypes.ReturnStatement;
  const getByIdFunction =
    getByIdReturnStmt.argument as recast.types.namedTypes.FunctionExpression;
                  ...
                  b.blockStatement([
                    b.expressionStatement(
                      b.callExpression(
                        ...
                        [
                          b.stringLiteral("Error creating example:"),
                          b.identifier("error"),
                        ],
                      ),
                    ),
  ...
  const createFunctionDecl =
    createControllerFunction.declaration as recast.types.namedTypes.FunctionDeclaration;
  const createReturnStmt = createFunctionDecl.body
    .body[0] as recast.types.namedTypes.ReturnStatement;
  const createFunction =
    createReturnStmt.argument as recast.types.namedTypes.FunctionExpression;
                  ...
                  b.blockStatement([
                    b.expressionStatement(
                      b.callExpression(
                        ...
                        [
                          b.stringLiteral("Error updating example:"),
                          b.identifier("error"),
                        ],
                      ),
                    ),
  ...
  // Get the function expression from the return statement - need to cast to access the proper types
  const updateFunctionDecl =
    updateControllerFunction.declaration as recast.types.namedTypes.FunctionDeclaration;
  const updateReturnStmt = updateFunctionDecl.body
    .body[0] as recast.types.namedTypes.ReturnStatement;
  const updateFunction =
    updateReturnStmt.argument as recast.types.namedTypes.FunctionExpression;
                        ...
                        b.objectExpression([
                          b.objectProperty(
                            ...
                            b.templateLiteral(
                              [
                                b.templateElement(
                                  { raw: "Example ", cooked: "Example " },
                                  false,
                                ),
                                b.templateElement(
                                  {
                                    raw: " deleted successfully",
                                    cooked: " deleted successfully",
                                  },
                                  true,
                                ),
                              ],
                  ...
                  b.blockStatement([
                    b.expressionStatement(
                      b.callExpression(
                        ...
                        [
                          b.stringLiteral("Error deleting example:"),
                          b.identifier("error"),
                        ],
                      ),
                    ),
  ...
  // Get the function expression from the return statement - need to cast to access the proper types
  const deleteFunctionDecl =
    deleteControllerFunction.declaration as recast.types.namedTypes.FunctionDeclaration;
  const deleteReturnStmt = deleteFunctionDecl.body
    .body[0] as recast.types.namedTypes.ReturnStatement;
  const deleteFunction =
    deleteReturnStmt.argument as recast.types.namedTypes.FunctionExpression;
